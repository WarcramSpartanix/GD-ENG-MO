...
PhysicsComponent::PhysicsComponent(std::string name, AGameObject* owner, bool isSphere) : AComponent(name, AComponent::ComponentType::Physics, owner), m_isSphere(isSphere)
{
